...
output:
  pagedown::html_resume:
    css: ['css/custom_cv.css', 'css/styles_cv.css', 'resume']
...
setwd("/Users/8yt/Documents/Personal/cv-resume/")
...
# Resume items
position_data <- read_csv('cv-positions-computational-biology.csv',show_col_types = FALSE) %>% 
  filter(in_resume)
# %>% 
#   mutate(
...
```{r}
intro_text <- "Computational biologist with expertise in multi-omics data integration, network biology, and single-nuclei transcriptomics, with a strong background applying these approaches to biomedical research. Experienced in developing computational methods, performing statistical analyses, and visualizing complex biological datasets using R and Python. Skilled in analyzing and interpreting large-scale biological datasets on high-performance computing systems. Interested in roles involving computational biology, bioinformatics, data science, software development, and data visualization."
