...
```{r}
intro_text <- "Data scientist with a background in computational biology with expertise in multi-omics data integration, network biology, and single-cell transcriptomics. Experienced in developing computational methods, statistical analyses, and visualization tools in R and Python, and running large-scale analyses on high-performance computing systems. Interested in roles involving data science, computational biology, software development, and data visualization."
# intro_text <- "I am a PhD candidate in the Data Science & Engineering program at the Bredesen Center for Interdisciplinary Research and Graduate Education, University of Tennessee, Knoxville. I am currently working as a graduate research assistant in Dr. Daniel Jacobson's computational systems biology group at Oak Ridge National Laboratory. My research focuses on developing systems biology multi-omics data tools for integration, visualization, and biological interpretation, and the application of these tools to complex human diseases including Niemann-Pick Type C disease."
